...
cd win_tests
C:\cygwin\bin\make PLATFORM=Windows CC=../llvm-build/bin/Debug/clang.exe CC_OUT='-g -D_CRTIMP="" -D_KERNEL3D_MT -D_DLL -c -o' CFLAGS=-faddress-sanitizer EXTRA_OBJ=../asan_rtl/asan_rtl.lib || goto :DIE
cd ..
